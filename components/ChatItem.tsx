...
const RenderChatItem = ({chatItem,username}:Props)=>{
    ...
    style={[
        ...
        <View style={Styles.chatItemHeader}>
            <Image source={{ uri: "data:image/jpeg;base64," + avatarImage,}} style={Styles.avatarSmall}/>
            <Text style={Styles.smallItalicText}>{chatItem.by} at {new Date(chatItem.timeStamp).toLocaleTimeString()}</Text>
        </View>
